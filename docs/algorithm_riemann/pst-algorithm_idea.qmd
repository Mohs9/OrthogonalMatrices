...
Then $\Omega$ is a skew-symmetric matrix, $\Omega=-\Omega'$. Thus, the tangent space at $Q$, consisting of the matrices $\mathbf{T}$, is $\mathfrak{T}_{Q} = \{\mathbf{T} = \Omega Q : \Omega = -\Omega'\}$.
